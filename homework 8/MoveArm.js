 ...
 * Assignment #: Mod 8 Assignment 1 part 1
 */
...
window.onload = function init() {
	...
	document.getElementById("bodyangle").oninput =
      function (event) {
          theta[Base] = event.target.value;
         
      };
	
	document.getElementById("lowerarm").oninput =
      function (event) {
          theta[LowerArm] = event.target.value;
         
      };

	document.getElementById("upperarm").oninput =
      function (event) {
