...
function initSceneNodes(Id) {
    ...
    switch (Id) {
        ...
        case columnId1:
            ...
            scene[columnId1] = createNode(m, column, columnId2, null, brown, grayish, 1, null);
            break;

        case columnId2:
            m = translate(colPosArray[columnId2]);
            scene[columnId2] = createNode(m, column, columnId3, null, brown, grayish, 2, null);
            break;
        ...
        case columnId4:
            ...
            scene[columnId4] = createNode(m, column, columnId5, null, brown, grayish, 1, null);
            break;

        case columnId5:
            m = translate(colPosArray[columnId5]);
            scene[columnId5] = createNode(m, column, columnId6, null, brown, grayish, 2, null);
            break;
        ...
        case columnId7:
            ...
            scene[columnId7] = createNode(m, column, columnId8, null, brown, grayish, 1, null);
            break;

        case columnId8:
            m = translate(colPosArray[columnId8]);
            scene[columnId8] = createNode(m, column, columnId9, null, brown, grayish, 2, null);
            break;
...
function traverseFigure(Id) {
    ...
    figure[Id].render(figure[Id].color1, figure[Id].color2, figure[Id].texIndex1, scene[Id].texIndex2);
...
function traverseScene(Id) {
    ...
    scene[Id].render(scene[Id].color1, scene[Id].color2, scene[Id].texIndex1, scene[Id].texIndex2);
