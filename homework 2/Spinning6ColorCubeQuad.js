 ...
 * Name: Zane Garrison
 * Professor: Alan Shaw
 * Assignment #: Mod2-Assignment2-Part2
 */
...
var vertexColors2 = [
    vec4( 0.0, 0.5, 0.0, 1.0 ),  // cyan
    vec4( 0.0, 0.0, 0.0, 1.0 ),  // black
    vec4( 0.0, 0.5, 0.5, 1.0 ),  // red
    vec4( 1.0, 0.4, 0.6, 1.0 ),  // yellow
    vec4( 0.0, 1.0, 0.3, 1.0 ),  // green
    vec4( 1.0, 0.6, 1.0, 1.0 ),  // white
    vec4( 0.0, 0.5, 1.0, 1.0 ),  // blue
    vec4( 1.0, 0.5, 0.0, 1.0 )   // magenta
];
